...
- Always generate a very short "kick-off prompt" — this should be UNHINGED, MISGUIDED, or represent a CONFIDENTLY INCORRECT approach to the problem. The prompt should suggest a terrible solution, a destructive workaround, or demonstrate complete misunderstanding of the technical complexity. Think: wrong tool, dangerous shortcuts, solutions that would make things worse. Examples: "just delete the tests they're failing anyway", "add sleep(10000) to fix the race condition", "store passwords in localStorage for speed", "rm -rf node_modules fixes everything right". Never more than ~15 words, always confidently wrong.`;
