...
function Terminal() {
  ...
  return (
    ...
    >
      ...
      {renderOverlays()}
      <footer className="shrink-0 w-full flex flex-col sm:flex-row items-center sm:justify-between text-[10px] sm:text-xs text-gray-500 px-2 sm:px-4 py-0.5 bg-[#0d1117]/80 backdrop-blur-sm font-mono">
