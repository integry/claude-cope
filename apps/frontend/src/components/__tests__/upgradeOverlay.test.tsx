...
function render(props: { quotaPercent: number; totalQuota: number; onDismiss: () => void }) {
...
describe("UpgradeOverlay", () => {
  ...
  it("renders both desktop and mobile layout containers in the DOM", () => {
    render({ quotaPercent: 65, totalQuota: 20, onDismiss: vi.fn() });
  ...
  it("does NOT call onDismiss when the backdrop is clicked (ESC-only)", () => {
    ...
    render({ quotaPercent: 65, totalQuota: 20, onDismiss });
