/**
 * Punchlines for social sharing — randomly selected when a user shares a chat.
 * Extracted to keep shareChatUtils.ts under the max-lines lint limit.
 */

export const SHARE_PUNCHLINES = [
  // Original 40
