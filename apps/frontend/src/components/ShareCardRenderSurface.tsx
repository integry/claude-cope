...
export default function ShareCardRenderSurface({
  ...
  return (
    <div
      id="share-card-root"
      className="w-[760px] overflow-hidden bg-[#0d1117] text-white"
    >
      ...
      <div className="px-6 py-6">
        <div className="inline-block max-w-full break-words bg-[#e5e7eb] px-3 py-2 font-mono text-[16px] font-bold text-[#111827]">
